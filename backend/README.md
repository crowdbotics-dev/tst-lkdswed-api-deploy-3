...
## Project Structure
    ...
    ├── tst_lkdswed_api_deploy_3  # Django project configurations
...
1. Clone this repo and `cd tst_lkdswed_api_deploy_3`
...
2. Clone this repo and `cd tst_lkdswed_api_deploy_3`
