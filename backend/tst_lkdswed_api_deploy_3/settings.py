"""
Django settings for tst_lkdswed_api_deploy_3 project.
...
ROOT_URLCONF = 'tst_lkdswed_api_deploy_3.urls'
...
WSGI_APPLICATION = 'tst_lkdswed_api_deploy_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_lkdswed_api_deploy_3 API",
    "DESCRIPTION": "API documentation for tst_lkdswed_api_deploy_3 App",
    "VERSION": "v1",
}
